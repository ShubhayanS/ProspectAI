...
4. **Generate message** using the 3-sentence framework adapted to contact type:
   ...
   - **Sentence 2 (Proof)**: Data point that answers their screening questions before they ask (e.g., "5 years building ML pipelines, currently in Philadelphia, available immediately")
...
5. **Versions**:
   - EN (default)
   - Other language only if the company is based in a non-English market and the candidate is targeting that market

6. **Alternative targets** with rationale for why they're good second choices
